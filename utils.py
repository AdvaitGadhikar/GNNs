...
def load_credit(dataset, sens_attr="Age", predict_attr="NoDefaultNextMonth", path="./credit/", label_number=1000, sens_number=100):
...
#    idx_features_labels['TotalMonthsOverdue'] = (idx_features_labels['TotalMonthsOverdue']-idx_features_labels['TotalMonthsOverdue'].mean())/idx_features_labels['TotalMonthsOverdue'].std()
    ...
    # print('Shape of data')
    # print(idx_features_labels[header].shape)
